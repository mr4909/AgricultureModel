...
final_hh_data_noNAs is standardized and scaled
...
factor28 <- fa(pca_df,nfactors = 28,rotate = "oblimin",fm="minres")
print(factor28)
```
...
print(factor28$loadings,cutoff = 0.3)
```
...
Run PCA with this set of variables to see what the compenents look like. Types of households.
Clustering k-means 
Fuzzy
Wellbeing, Food - same recall
