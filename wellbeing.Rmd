...
hh_health <- hh_health %>% mutate(canCarry20L = n.x,
                                  canWalk5Km = n.y,
                                  canStandOwn = n)
hh_health <- hh_health %>% mutate(pctCanCarry20L = canCarry20L/hh_members,
...
facilities_all$visits_healthcenter <- ifelse(grepl("1",facilities_all$facilities), 1, 0)
facilities_all$visits_bazaar <- ifelse(grepl("6",facilities_all$facilities), 1, 0)
facilities_all$visits_localshop <- ifelse(grepl("5",facilities_all$facilities), 1, 0)

# calculate distance to health center
healthcenter <- facilities_all %>% filter(visits_healthcenter == 0)
...
# calculate distance to bazaar


# calculate distance to local shop
