...
# merge fooddiary_count (unit = 8) and other dataset fooddiary_count
...
# Calculate Z score
# Z <- outliers(final_df_food$avg_calories_member) 
#  
...
Q <- quantile(final_df_food$avg_calories_member, probs=c(.25, .75), na.rm = FALSE)
iqr <- IQR(final_df_food$avg_calories_member)
up <-  Q[2]+1.5*iqr # Upper Range  
low<- Q[1]-1.5*iqr # Lower Range

############################################
# Final data without calorie outliers
############################################

final_df_no_outliers <- subset(final_df_food, final_df_food$avg_calories_member > (Q[1] - 1.5*iqr) & final_df_food$avg_calories_member < (Q[2]+1.5*iqr))
summary(final_df_no_outliers$avg_calories_member)
```
...
```{r}
fviz_eig(res.pca, addlabels = TRUE, ylim = c(0, 15))
```
