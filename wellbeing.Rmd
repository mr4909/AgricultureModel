...
if (fooddiary_cleaned$food_type_quant==1) {
  
    fooddiary_cleaned$calories_total = fooddiary_cleaned$calories_grams* 
  ...
  fooddiary_cleaned$food_type_quant*1000
} else if (fooddiary_cleaned$food_type_quant==2) {
fooddiary_cleaned$calories_total = fooddiary_cleaned$calories_grams*1000
} else if (fooddiary_cleaned$food_type_quant==3) {
fooddiary_cleaned$calories_total = fooddiary_cleaned$calories_grams*1000
} else if (fooddiary_cleaned$food_type_quant==4) {
fooddiary_cleaned$calories_total = fooddiary_cleaned$calories_grams*1000
} else if (fooddiary_cleaned$food_type_quant==5) {
fooddiary_cleaned$calories_total = fooddiary_cleaned$calories_grams*1000
} else if (fooddiary_cleaned$food_type_quant==6) {
fooddiary_cleaned$calories_total = fooddiary_cleaned$calories_grams*1000
} else if (fooddiary_cleaned$food_type_quant==7) {
fooddiary_cleaned$calories_total = fooddiary_cleaned$calories_grams*1000
} else {
fooddiary_cleaned$calories_total = "not sure (count)"
}
```

## Plots
```{r}
p1 <- ggplot(fooddiary_cleaned, aes(x=submission_month, y=calories_grams)) +
  geom_line(color="#69b3a2", size=2) +
  ggtitle("Calories reported by month")

p2 <- ggplot(fooddiary_cleaned, aes(x=week_number, y=calories_grams)) +
  geom_line(color="#69b3a2", size=2) +
  ggtitle("Calories reported by week")

p3 <- ggplot(fooddiary_cleaned, aes(x=time_of_day, y=calories_grams)) +
  geom_line(color="#69b3a2", size=2) +
  ggtitle("Calories reported by time of day")

p4 <- ggplot(fooddiary_cleaned, aes(x=submission_weekday, y=calories_grams)) +
  geom_line(color="#69b3a2", size=2) +
